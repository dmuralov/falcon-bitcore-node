...
**Note**: To install services [insight-api](https://github.com/dmitry9888/falcon-insight-api) and [insight-ui](https://github.com/dmitry9888/falcon-insight-ui) you'll need to clone the repositories locally.
